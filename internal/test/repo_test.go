...
// setupPostgresContainer initializes a PostgreSQL container for the tests
func SetupPostgresContainer(ctx context.Context) (testcontainers.Container, string, *gorm.DB, error) {
	...
	return pgContainer, connStr, instance, nil
}
